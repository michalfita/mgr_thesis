...
typedef struct PmBytes_s
{
    ...
    /** C array of bytes */
    uint8_t val[1];
} __attribute__((__may_alias__)) PmBytes_t,
  __attribute__((__may_alias__)) *pPmBytes_t;
...
typedef struct PmBytearray_s
{
    ...
    pPmBytes_t val;
} __attribute__((__may_alias__)) PmBytearray_t,
  __attribute__((__may_alias__)) *pPmBytearray_t;
