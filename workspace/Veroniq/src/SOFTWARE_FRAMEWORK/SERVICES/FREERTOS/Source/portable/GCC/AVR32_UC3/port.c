...
/* External declaration for setting up the CPU clock */
extern void vq_init_clock(void);
 ...
 */
#if 0 /* Port function moved into heap.c in platform directory of the project */
